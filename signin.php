...
<main class="container justify-content-center mx-auto">
  <div class="col-md-6 offset-md-3">
    <form class="form-signin" method="post" action="signin.php">      
      ...
      <input type="email" id="inputEmail" class="form-control mb-2" placeholder="Correo electrónico" name="email" required autofocus>
      ...
      <p class="mt-5 mb-3 text-muted">No tengo una <a href="signup.php">cuenta</a> aún, olvidé mi <a href="recovery.php">contraseña</a></p>  
    </form>
  </div>  
</main>    
<?php  
