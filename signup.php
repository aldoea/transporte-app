<?php  
  ...
  if (isset($_POST['crear'])) {
    ...
    */
    ...
    $validation_errors = [];
    if ( !(!is_null($nombre) && strlen($nombre) > 5) ) {
    ...
    if (count($validation_errors) == 0) {
      $dreamtour->registrar($nombre, $email, $telefono, $contrasena, $contrasena_repeat);
    }else{
  ...
  <div class="col-md-6 offset-md-3">
    <form class="form-signin" method="post" action="signup.php">      
      ...
      <div class="form-group">
          ...
          <input type="text" name="nombre" class="form-control" id="nombre" aria-describedby="nombre" placeholder="Nombre y apellido" required="">
          <label for="correo">Correo</label>            
          <input type="email" name="email" class="form-control" id="correo" aria-describedby="correo" placeholder="Correo" required="">
          <label for="telefono">Telefono</label>
          <input type="tel" name="telefono" class="form-control" id="telefono" aria-describedby="telefono" placeholder="Telefono">          
